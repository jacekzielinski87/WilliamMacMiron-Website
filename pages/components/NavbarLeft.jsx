...
const NavbarLeft = () => {
  ...
  return (
    <div className="bg-[#C8C8C8] h-[40px] border-2 border-black rounded-r-none rounded-t-3xl fixed bottom-0 right-1/2 w-[460px] flex items-center justify-center mr-5">
