  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex justify-center w-full z-60">
      <div
        ...
        h-[58px]
        flex items-center
        bg-[url('/assets/cork-texture.png')] bg-repeat border-r-8 border-black border-opacity-35 border-l-8 border-black border-opacity-35 border-t-8 border-black border-opacity-35 shadow-2xl shadow-slate-900"
      >
